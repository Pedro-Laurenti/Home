            ...
            <section className={styles.accordion}>
                <section className={`${styles.accordion} ${styles['accordion--radio']}`}>
                    ...
                    <div className={styles.tab}>
                        ...
                        <label htmlFor="rd2" className={styles['tab__label']}> COMO FUNCIONA O TRATAMENTO? </label>
                        <div className={styles['tab__content']}>
                    ...
                    <div className={styles.tab}>
                        ...
                        <label htmlFor="rd3" className={styles['tab__label']}> QUAIS SÃO AS INDICAÇÕES? </label>
                        <div className={styles['tab__content']}>
                    ...
                    <div className={styles.tab}>
                        ...
                        <label htmlFor="rd5" className={styles['tab__label']}> O QUE É O MÉTODO DE INTERVENÇÃO? </label>
                        <div className={styles['tab__content']}>
                    ...
                    <div className={styles.tab}>
                        ...
                        <label htmlFor="rd6" className={styles['tab__label']}> O QUE É O PROTOCOLO PEDIASUIT? </label>
                        <div className={styles['tab__content']}>
                    ...
                    <div className={styles.tab}>
                        ...
                        <label htmlFor="rd7" className={styles['tab__label']}> QUAIS SÃO OS BENEFÍCIOS DO PROTOCOLO PEDIASUIT </label>
                        <div className={styles['tab__content']}>
                    ...
                    <div className={styles.tab}>
                        ...
                        <label htmlFor="rd8" className={styles['tab__label']}> O QUE É TERAPIA INTENSIVA? </label>
                        <div className={styles['tab__content']}>
