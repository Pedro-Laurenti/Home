            ...
            <section className={styles.accordion}>
                <section className={`${styles.accordion} ${styles['accordion--radio']}`}>
                    <div className={styles.tab}>
                        ...
                        <label for="rd1" className={styles['tab__label']}>
                            O QUE É BOBATH? 
                        </label>
                    ...
                    <div className={styles.tab}>
                        ...
                        <label for="rd2" className={styles['tab__label']}> COMO FUNCIONA O TRATAMENTO? </label>
                        <div className={styles['tab__content']}>
                    ...
                    <div className={styles.tab}>
                        ...
                        <label for="rd3" className={styles['tab__label']}> QUAIS SÃO AS INDICAÇÕES? </label>
                        <div className={styles['tab__content']}>
                    ...
                    <div className={styles.tab}>
                        ...
                        <label for="rd4" className={styles['tab__label']}> O QUE É ABA? </label>
                        <div className={styles['tab__content']}>
                    ...
                    <div className={styles.tab}>
                        ...
                        <label for="rd5" className={styles['tab__label']}> O QUE É O MÉTODO DE INTERVENÇÃO? </label>
                        <div className={styles['tab__content']}>
                    ...
                    <div className={styles.tab}>
                        ...
                        <label for="rd6" className={styles['tab__label']}> O QUE É O PROTOCOLO PEDIASUIT? </label>
                        <div className={styles['tab__content']}>
                            <p> riado em 2006 por um brasileiro, para utilizar na reabilitação do seu filho que têm paralisia cerebral, o PediaSuit é uma vestimenta ortopédica e proprioceptiva, para ser utilizada na terapia intensiva com o Protocolo PediaSuit.
                    ...
                    <div className={styles.tab}>
                        ...
                        <label for="rd7" className={styles['tab__label']}> QUAIS SÃO OS BENEFÍCIOS DO PROTOCOLO PEDIASUIT </label>
                        <div className={styles['tab__content']}>
                            ...
                            Os benefícios também são vários, como:
                            <ul>
                            ...
                            Porém, precisamos nos informar também quanto às contraindicações para este tipo de tratamento e também as precauções de alguns casos, como para qualquer outro tratamento. O Protocolo PediaSuit, é hoje um método de grande procura pelas famílias de todos os lugares do Brasil e do mundo, devido ao seu excelente desempenho nos resultados obtidos pelos pacientes que participam da terapia intensiva através deste método. É importante ressaltar também que é necessário que o profissional seja certificado no método para executar o Protocolo PediaSuit.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className={styles.tab}>
                        ...
                        <label for="rd8" className={styles['tab__label']}> O QUE É TERAPIA INTENSIVA? </label>
                        <div className={styles['tab__content']}>
                    ...
                    <div className={styles.tab}>
                        <input type="radio" name="accordion-2" id="rd1" />
                        <label for="rd1" className={styles['tab__close']}>
                        </label>
                    </div>
                </section>
            </section>
